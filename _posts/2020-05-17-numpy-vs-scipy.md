...
**[넘파이]:** 행렬 및 관련 기초 연산을 지원합니다. 행렬 그 자체에 대한 지원과 더불어, 행렬의 정렬이나 형태 변환과 같이 행렬에서 사용하는 기본적인 연산을 지원합니다.
...
**[사이파이]:** ([넘파이]에서 제공하는) 행렬에 기반한 수학, 과학 알고리즘을 지원합니다. [넘파이]에 비해 더 많은 기능을 가진 FFT, 선형대수 알고리즘을 지원합니다.

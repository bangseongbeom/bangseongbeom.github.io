...
HTML 5에서 시맨틱 태그가 도입되었습니다. [`<section>`][section-element], [`<main>`][main-element], [`<nav>`][nav-element] 등이 모두 시맨틱 태그입니다. 이들은 HTML 문서에 의미를 부여한다고 해서 '의미 있는'이라는 뜻의 영어 단어인 '시맨틱(semantic)'을 붙여 시맨틱 태그라고 부릅니다.

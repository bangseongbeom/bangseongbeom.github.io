...
안드로이드 SDK에서 코틀린 지원 안 하니까 나도 코틀린 안 써! 같은 심정으로 코틀린의 도입을 미뤄왔으나, 안드로이드 파이(9.0)에서 코틀린을 본격적으로 지원해버려서 이제는 정말 코틀린을 도입할 수밖에 없습니다.
...
**코틀린, 네, 아주 좋습니다. 하지만 언어와 관련된 프레임워크와 도구들이 언어를 효과적으로 지원해야 합니다.** 문법 강조도 제대로 되지 않고 기존 프레임워크도 마음대로 쓸 수 없다면 아무리 문법이 좋아봤자 쓰기 힘들 것입니다. 이처럼 우리는 언어를 선택함으로써 얻는 이익뿐만 아니라 잠재적인 문제점까지 함께 고려하는 것이 필요합니다. 그렇지 않으면 장점보다 단점이 더 커져버리게 됩니다.

...
**완전히 독립적인 여러 서비스**를 운영한다고 하더라도 단일 저장소를 사용할 수 있습니다. 스타트업과 같이 규모가 작은 기업의 경우 서비스 별로 개발자들이 완벽하게 나뉘기가 어렵습니다. 한 개발자가 여러 서비스에 걸쳐 무언가를 개발하거나, 아니면 적어도 **다른 서비스에 대한 진행 상황(즉 버전 기록)을 확인할 필요가 있기 때문입니다**.
